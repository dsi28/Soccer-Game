...
public class MainActivity extends AppCompatActivity {
    int scoreA = 0, scoreB = 0, foulA = 0, foulB = 0, tempSA = scoreA, tempSB = scoreB, tempFA = foulA, tempFB = foulB;
    ...
    private void updateScoreB(int scoreB) {
        TextView scoreTVB = (TextView) findViewById(R.id.scoreB);
    ...
    private void updateFoulB(int foulB) {
        TextView foulBTV = (TextView) findViewById(R.id.foulB);
    ...
    private void updateFoul(int foulA) {
        TextView foulTV = (TextView) findViewById(R.id.foulA);
        foulTV.setText("" + foulA);
    }


    private void updateScoreA(int score) {
        TextView scoreTV = (TextView) findViewById(R.id.scoreA);
